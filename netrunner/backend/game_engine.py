...
# Each alert has varied narrative text so reviews feel like in-world combat events.
INTRUSION_ALERTS = [
    {
        "title": "\u26a0 FEINDLICHER SCAN",
        "message": "Ein feindlicher Scanner tastet deine Firewall ab. Aktiviere Gegenma\u00dfnahmen!",
        "prefix": "Alter Angriff, neues Timing. Du kennst die L\u00f6sung \u2014 beweis es.",
        "echo_success": "Scan neutralisiert. Dein Wissen sitzt.",
        "echo_fail": "Abwehr gescheitert. Du hast das schon gel\u00f6st \u2014 erinnere dich.",
    },
    {
        "title": "\u26a0 NETZWERK-ANOMALIE",
        "message": "Unbekannte Signatur im System erkannt. Identifiziere und eliminiere!",
        "prefix": "Gleiche Anomalie, gleiche Schwachstelle. Du wei\u00dft, was zu tun ist.",
        "echo_success": "Anomalie eliminiert. System stabil.",
        "echo_fail": "Die Anomalie breitet sich aus. Fokus!",
    },
    {
        "title": "\u26a1 INTRUSION DETECTED",
        "message": "Eindringling im System! Sofortige Abwehr erforderlich!",
        "prefix": "Der Angreifer nutzt eine bekannte Schwachstelle. Du hast die Gegenma\u00dfnahme.",
        "echo_success": "Eindringling abgewehrt. Firewall h\u00e4lt.",
        "echo_fail": "Eindringling noch aktiv. Nochmal!",
    },
    {
        "title": "\u26a0 SIGNAL ABGEFANGEN",
        "message": "Feindliches Signal im Netzwerk. Entschl\u00fcssle und neutralisiere!",
        "prefix": "Dieses Signal hast du schon einmal geknackt. Zeig, dass du es noch kannst.",
        "echo_success": "Signal decodiert und neutralisiert.",
        "echo_fail": "Signal noch aktiv. Denk nach.",
    },
    {
        "title": "\u26a0 FIREWALL-BREACH",
        "message": "Deine Firewall wurde durchbrochen! Schlie\u00dfe die L\u00fccke!",
        "prefix": "Die L\u00fccke ist dir bekannt. Schnell \u2014 bevor der Schaden gr\u00f6\u00dfer wird.",
        "echo_success": "L\u00fccke geschlossen. Firewall wiederhergestellt.",
        "echo_fail": "Breach noch offen. Der Code muss stimmen.",
    },
    {
        "title": "\u26a0 MEMORY LEAK",
        "message": "Speicherleck erkannt! Dein System verliert Daten. Repariere sofort!",
        "prefix": "Dein Ged\u00e4chtnis wird getestet. Was wei\u00dft du noch?",
        "echo_success": "Speicher repariert. Keine Datenverluste.",
        "echo_fail": "Daten gehen verloren. Erinnere dich an die L\u00f6sung.",
    },
    {
        "title": "\u26a0 CIPHER-ATTACKE",
        "message": "CIPHER sendet verschl\u00fcsselte Angriffe. Entschl\u00fcssle und konter!",
        "prefix": "CIPHERs Methoden \u00e4ndern sich nicht. Du kennst das Muster.",
        "echo_success": "Angriff entschl\u00fcsselt und gekontert.",
        "echo_fail": "CIPHERs Attacke wirkt noch. Bleib dran.",
    },
    {
        "title": "\u26a0 SYSTEM-DIAGNOSE",
        "message": "Routine-Scan zeigt Schwachstelle. Best\u00e4tige deine Systemintegrit\u00e4t!",
        "prefix": "Routine-Check. Beweise, dass dein Wissen aktuell ist.",
        "echo_success": "System-Check bestanden. Alles im gr\u00fcnen Bereich.",
        "echo_fail": "Check fehlgeschlagen. Nochmal.",
    },
    {
        "title": "\u26a1 GHOST SIGNAL",
        "message": "Ein Geistersignal taucht im Netz auf. Identifiziere die Quelle!",
        "prefix": "Geistersignale sind Echos alter Aktionen. Dieses hier kennst du.",
        "echo_success": "Geistersignal identifiziert und gel\u00f6scht.",
        "echo_fail": "Das Signal verst\u00e4rkt sich. Konzentrier dich.",
    },
    {
        "title": "\u26a0 NEXUS-\u00dcBERWACHUNG",
        "message": "NEXUS Corporation scannt dein System! T\u00e4usche den Scanner!",
        "prefix": "NEXUS sucht nach Schwachstellen. Zeig keine.",
        "echo_success": "NEXUS-Scan \u00fcberlistet. Du bist unsichtbar.",
        "echo_fail": "NEXUS hat dich im Visier. Schneller!",
    },
    {
        "title": "\u26a0 DATEN-KORRUPTION",
        "message": "Korrupte Datenpakete erkannt! Stelle die Integrit\u00e4t wieder her!",
        "prefix": "Deine Daten brauchen ein Refresh. Zeig, was du noch wei\u00dft.",
        "echo_success": "Daten wiederhergestellt. Integrit\u00e4t best\u00e4tigt.",
        "echo_fail": "Korruption breitet sich aus. Versuch es nochmal.",
    },
    {
        "title": "\u26a0 ECHO-PR\u00dcFUNG",
        "message": "ECHO: Ich muss sicher sein, dass du das noch kannst. Nichts Pers\u00f6nliches.",
        "prefix": "Ich teste dich nicht gern. Aber es ist notwendig. Zeig mir, dass du es noch drauf hast.",
        "echo_success": "Gut. Ich wusste, dass du es noch kannst. Wirklich.",
        "echo_fail": "Nicht schlimm. Nochmal. Ich hab Geduld. Mehr als du denkst.",
    },
]


def wrap_review_challenge(challenge: dict, review_info: dict) -> dict:
    """Wrap a completed challenge as an intrusion alert review with varied story text."""
    alert = random.choice(INTRUSION_ALERTS)
    return {
        **challenge,
        "is_review": True,
        "intrusion_alert": alert,
        "original_description": challenge.get("description", ""),
        "description": f"ECHO: {alert['prefix']}\n\n{challenge['description']}",
        "echo_success": alert["echo_success"],
        "echo_fail": alert["echo_fail"],
...
async def get_current_session() -> dict:
    ...
    for review in reviews[:10]:
        ...
        if challenge:
            review_challenges.append(wrap_review_challenge(challenge, review))

    # Enrich current mission challenges with progress data
    enriched_mission = None
    if current:
        enriched_challenges = []
        for ch in current.get("challenges", []):
            progress = await get_challenge_progress(ch["id"])
        ...
        enriched_mission = {**current, "challenges": enriched_challenges}
    ...
    return {
        "player": player.to_dict(),
        "mode": mode,
        "current_mission": enriched_mission,
        "reviews_due": len(reviews),
        "review_challenges": review_challenges,
        "interleave_reviews": bool(review_challenges) and not daily_cap_reached,
